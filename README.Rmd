...
Then set the model parameters. The design pattern for catlearn is a _stateful list processor_. This means we provide the model with a list that contains all of the models hyperparamters.
